...
import { TShirtProductsQuery } from "@/sanity/lib/queries";
...
const TShirts = () => {
    ...
    useEffect(() => {
        async function fetchproduct() {
            const fetchedProduct : product [] = await client.fetch(TShirtProductsQuery)
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 ">
            <h1 className="text-2xl font-bold mb-6 text-center">T-Shirts</h1>
