...
import { HoodieProductsQuery } from "@/sanity/lib/queries";
...
const TopSell = () => {
    ...
    useEffect(() => {
        async function fetchproduct() {
            const fetchedProduct : product [] = await client.fetch(HoodieProductsQuery)
    ...
    return (
        <div id="TopSell" className="max-w-6xl mx-auto px-4 py-8 ">
            <h1 className="text-2xl font-bold mb-6 text-center">Top Sell</h1>
