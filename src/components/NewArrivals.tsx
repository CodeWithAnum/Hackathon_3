...
import { JeansProductsQuery } from "@/sanity/lib/queries";
...
const NewArrivals = () => {
    ...
    useEffect(() => {
        async function fetchproduct() {
            const fetchedProduct : product [] = await client.fetch(JeansProductsQuery);
    ...
    return (
        <div id="NewArrivals" className="max-w-6xl mx-auto px-4 py-8 ">
